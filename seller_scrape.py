...
def extract_listing_data(listing):
    ...
    category_id = category_tag["data-et-prop-category_id"] if category_tag else "N/A"
        ...
        # Try to extract category name from size_tag href (e.g., '/category/Men-Shoes')
    category_name = "N/A"
...
def scrape_all_seller_items(seller, headers, closet_params, max_pages, delay_range):
    all_items = []
    stats = {"Listings": "N/A", "Followers": "N/A", "Following": "N/A"}
...
def process_single_seller(i, seller, headers, closet_params, max_pages, delay_range, item_output_folder):
    # print(f"[{i}] Scraping seller: {seller}")
    stats, all_items = scrape_all_seller_items(seller, headers, closet_params, max_pages, delay_range)
